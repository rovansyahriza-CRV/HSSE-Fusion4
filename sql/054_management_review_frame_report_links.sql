-- Management Review discussion frame -- tambah kolom "id" per item supaya UI
-- bisa membuat link langsung ke laporan/PDF modul asal. Run after 053.
-- Safe to rerun (CREATE OR REPLACE, tidak mengubah struktur tabel manapun).

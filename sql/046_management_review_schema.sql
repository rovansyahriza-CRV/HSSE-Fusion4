...
BEGIN
    ...
    FROM (
        SELECT jsonb_build_object(
            ...
            'createdByQrCodeId', r."CreatedByQrCodeId", 'attachments', r."Attachments",
            ...
            'actions', COALESCE((
                ...
                ) ORDER BY a."DueDate" NULLS LAST, a."Id")), '[]'::jsonb)
